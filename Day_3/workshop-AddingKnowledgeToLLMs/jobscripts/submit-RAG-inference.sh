...
#SBATCH --error=logs/logs-RAG-inference-%j.err          # standard error file
#SBATCH --output=logs/logs-RAG-inference-%j.out         # standard output file
...
export SAVE_PATH_FAISS_INDEX="/leonardo_work/tra26_minwinsc/workshop-AddingKnowledgeToLLMs/FT-models/RAG/RAG-faiss-index.idx"
...
python pythonInferenceScripts/inference-RAG.py
