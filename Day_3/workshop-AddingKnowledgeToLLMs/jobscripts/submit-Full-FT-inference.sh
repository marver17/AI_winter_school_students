...
#SBATCH --error=logs/logs-Full-FT-inference-%j.err          # standard error file
#SBATCH --output=logs/logs-Full-FT-inference-%j.out         # standard output file
...
export SAVE_PATH_FULL_MODEL="/leonardo_work/tra26_minwinsc/workshop-AddingKnowledgeToLLMs/FT-models/full_model_chatdoctor_gemma-2-2b-it/checkpoint-564/"
...
python pythonInferenceScripts/inference-Full-FT.py

# Training Done
sleep 2
echo "Full FT Inference OK"
